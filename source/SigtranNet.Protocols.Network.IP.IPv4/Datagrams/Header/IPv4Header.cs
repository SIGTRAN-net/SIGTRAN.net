...
using SigtranNet.Protocols.Network.IP.Datagrams;
...
internal readonly partial struct IPv4Header : IIPHeader<IPv4Header>
{
    ...
    ///     </code>
    /// </remarks>
    internal const InternetProtocolVersion Version = InternetProtocolVersion.IPv4;
    ...
    ///     </code>
    /// </remarks>
    internal readonly InternetProtocol protocol;
    ...
    /*
    public static IPv4Header FromReadOnlyMemory(ReadOnlyMemory<byte> data)
    {
