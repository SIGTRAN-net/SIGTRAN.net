...
namespace SigtranNet.Protocols.Network.IP.Exceptions {
    ...
    internal class ExceptionMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The construction of Internet Protocol controller for protocol &apos;{0}&apos; failed (type: &apos;{1}&apos;)..
        /// </summary>
        internal static string IPProtocolControllerConstructionFailed {
            get {
                return ResourceManager.GetString("IPProtocolControllerConstructionFailed", resourceCulture);
            }
        }
